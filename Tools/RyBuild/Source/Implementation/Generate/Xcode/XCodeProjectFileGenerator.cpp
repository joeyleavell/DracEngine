...
*/
		WriteLineAddIndent(DebugTargetUuid.ToString() + " = {");
		{
			...
			WriteLineAddIndent("buildSettings = {");
			{
				...
				WriteLine("ALWAYS_SEARCH_USER_PATHS = NO;");
				WriteLine("CLANG_CXX_LANGUAGE_STANDARD = \"gnu++17\";");
				WriteLine("CLANG_CXX_LIBRARY = \"libc++\";");
				WriteLine("GCC_C_LANGUAGE_STANDARD = gnu11;");
				WriteLine("MACOSX_DEPLOYMENT_TARGET = 11.3;");
				WriteLine("SDKROOT = macosx;");
			}
			WriteLineRemoveIndent("};");
