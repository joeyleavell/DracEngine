...
{
    PixelOutput Out;
    Out.PixelColor = texture(SPIRV_Cross_CombinedFontTextureFontSampler, In.VertTexCoord);
...
void main()
{
    ...
    PixelOutput _30 = src_main(param_var_In);
    out_var_SV_Target = _30.PixelColor;
}
