...
void main()
{
    VertexInput param_var_In = VertexInput(in_var_SV_Position, in_var_COLOR);
    VertexOutput _30 = src_main(param_var_In);
    gl_Position = _30.VertPos;
    out_var_COLOR = _30.VertColor;
}
