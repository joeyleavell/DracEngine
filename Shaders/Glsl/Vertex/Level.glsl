...
layout(binding = 1, std140) uniform type_Model
{
    mat4 Transform;
} Model;
...
{
    VertexOutput Out;
    Out.VertPos = (vec4(In.VertPos, 1.0) * Model.Transform) * Scene.ViewProjection;
...
void main()
{
    ...
    VertexOutput _40 = src_main(param_var_In);
    gl_Position = _40.VertPos;
    out_var_TEXCOORD = _40.VertUV;
    out_var_NORMAL = _40.VertNormal;
}
