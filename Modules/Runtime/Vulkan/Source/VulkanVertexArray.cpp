...
namespace Ry
{
	...
	void VulkanVertexArray::PushIndexData(uint32* Indices, uint32 Count)
	{
		...
		{
			this->StagingIndexBuffer = new VulkanBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT, VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT, Size);
