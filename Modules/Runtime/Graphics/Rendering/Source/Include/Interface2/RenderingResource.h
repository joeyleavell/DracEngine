...
namespace Ry
{
	...
	class RENDERING_MODULE ResourceSetDescription
	{
	public:
		...
		ResourceSetDescription(const Ry::ArrayList<ShaderStage>& Stages, int32 SetIndex = 0)
		{
	...
	public:
		...
		const ResourceSetDescription* GetInfo() const
		{
			return Info;
		}
