...
namespace Ry
{
	...
	Mesh2::Mesh2(const VertexFormat& Format)
	{
		this->Hint = Hint;
		this->VertArray = NewRenderAPI->CreateVertexArray(Format);
		this->Data = new MeshData;
		this->Data->Format = Format;
		this->StoredBoundingBox = nullptr;
	}

	Mesh2::Mesh2(MeshData* Data)
	{
		this->Data = Data;
		this->VertArray = NewRenderAPI->CreateVertexArray(Data->Format);
		this->StoredBoundingBox = nullptr;
	...
	// void Mesh2::Render(Primitive prim)
	// {
	// 	Mesh::Render(prim, Ry::IDENTITY_4, Ry::IDENTITY_4, nullptr);
	// }
	//
	// void Mesh2::Render(Primitive prim, const Ry::Matrix4& Model, const Ry::Matrix4& ViewProjection, const SceneLighting* Lighting)
	// {
	...
	MeshData* Mesh2::GetMeshData()
	{
		return Data;
	}

	VertexArray2* Mesh2::GetVertexArray()
	{
		return VertArray;
	}

	BoundingBox& Mesh2::GetBoundingBox()
	{
