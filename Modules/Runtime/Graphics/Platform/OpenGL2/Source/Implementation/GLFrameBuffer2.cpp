#include "GLFrameBuffer2.h"
#include "GLTexture2.h"

namespace Ry
{
	GLFrameBuffer2::GLFrameBuffer2(int32 Width, int32 Height, int32 Samples):
	FrameBuffer2(Width, Height, Samples)
	{
	...
	void GLFrameBuffer2::DeleteFramebuffer()
	{
