...
namespace Ry
{
	...
	void GLResources2::CreateBuffer()
	{

	}

	void GLResources2::DeleteBuffer()
	{
		for (ConstantBuffer* ConstBuffer : Info->ConstantBuffers)
		{
	...
	void GLResources2::MapData(MappedUniformBuffer* Dst, const ConstantBuffer* Src)
	{
		Ry::String ParentID = "";
		int32 Marker = 0;
	...
	void GLResources2::MapData_Helper(MappedUniformBuffer* Dst, const BufferMember* Member, Ry::String ParentId, int32& Marker)
	{
		int32 Alignment = GLCalcAlignmentRequirement(Member);
