...
namespace Ry
{
	...
	class RENDERINGCORE_MODULE RenderingPass
	{
	public:
	...
	class RENDERINGCORE_MODULE ImposePass : public RenderingPass
	{
	public:
	...
	class RENDERINGCORE_MODULE OffScreenRenderingPass : public RenderingPass
	{
	public:
	...
	class RENDERINGCORE_MODULE PostProcessPass : public OffScreenRenderingPass
	{
	public:
